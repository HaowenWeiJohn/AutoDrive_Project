...
# make data generator
x_train_dir = '../../data/train_test_val/val/x'
y_train_dir = '../../data/train_test_val/val/y'
x_val_dir = '../../data/train_test_val/val/x'
y_val_dir = '../../data/train_test_val/val/y'
...
train_data_gen = CustomDataGen(df=None, X_dir=x_train_dir, y_dir=y_train_dir, X_col='x_files', y_col='y_files', batch_size=20, shuffle=True)
val_data_gen = CustomDataGen(df=None, X_dir=x_val_dir, y_dir=y_val_dir, X_col='x_files', y_col='y_files', batch_size=20, shuffle=True)
