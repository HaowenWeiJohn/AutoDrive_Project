...
class ResBlock(nn.Module):
    def __init__(self, in_filters, out_filters, dropout_rate, kernel_size=(3, 3), stride=1,
        ...
        self.conv1 = nn.Conv2d(in_filters, out_filters, kernel_size=(1, 1), stride=(stride, stride))
        self.act1 = nn.LeakyReLU()
        ...
        self.conv3 = nn.Conv2d(out_filters, out_filters, kernel_size=(3, 3), dilation=(2, 2), padding=2)
        self.act3 = nn.LeakyReLU()
        self.bn2 = nn.BatchNorm2d(out_filters)

        self.conv4 = nn.Conv2d(out_filters, out_filters, kernel_size=(2, 2), dilation=(2, 2), padding=1)
...
class UpBlock(nn.Module):
    def __init__(self, in_filters, out_filters, dropout_rate, drop_out=True):
        ...
        self.conv2 = nn.Conv2d(out_filters, out_filters, (3, 3), dilation=(2, 2), padding=2)
        self.act2 = nn.LeakyReLU()
        self.bn2 = nn.BatchNorm2d(out_filters)

        self.conv3 = nn.Conv2d(out_filters, out_filters, (2, 2), dilation=(2, 2), padding=1)
        self.act3 = nn.LeakyReLU()
        self.bn3 = nn.BatchNorm2d(out_filters)
...
class SalsaNext(nn.Module):
    def __init__(self, nclasses, input_channel_num=32):
        super(SalsaNext, self).__init__()
        self.nclasses = nclasses

        self.downCntx = ResContextBlock(input_channel_num, 32)
        self.downCntx2 = ResContextBlock(32, 32)
        self.downCntx3 = ResContextBlock(32, 32)

        self.resBlock1 = ResBlock(32, 2 * 32, 0.2, pooling=True, drop_out=False)  # 32----64----128----256----256
        ...
        self.upBlock1 = UpBlock(2 * 4 * 32, 4 * 32, 0.2)  # 256----256----256----128----32
