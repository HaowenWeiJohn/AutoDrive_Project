...
for sequence in sequences:
    ...
    samples_folder = os.path.join(this_sequence_folder, 'range_images_folder')
    ...
    for sample_file_name in tqdm(samples_file_name):
        ...
        sample_save_file_name = os.path.join(data_folder, x_folder, sequence+'_'+sample_file_name)
        # res images
        for back_track_n in back_track_ns:
            res_image_path = os.path.join(this_sequence_folder, 'residual_images_'+str(back_track_n), sample_file_name)
